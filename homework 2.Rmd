...
We can observe that we have a decrease on the variance. Since we observe the Unbiased estimator of var with max boostraping, we are looking for the most 